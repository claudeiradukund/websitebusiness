...
$result_qerry=mysqli_query($con,$get_data);
$row=mysqli_fetch_assoc($result_qerry);
...
$select_category="select * from `categories` where cetegory_id=$category_id";
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_image1" class="form-label">Product Image1</label>
               <div class="d-flex">
                   <input type="file" id="product_image1" name="product_image1" class="form-control w-80 m-auto" required="required">
                   <img src="\website\admin_area/product_images/<?php echo $product_image1 ?>" alt="" class="product-img">
               </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_image2" class="form-label">Product Image2</label>
               <div class="d-flex">
                   <input type="file" id="product_image2" name="product_image2" class="form-control w-80 m-auto" required="required">
                   <img src="\website\admin_area/product_images/<?php echo $product_image2 ?>" alt="" class="product-img">
               </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
            <label for="product_image3" class="form-label">Product Image3</label>
               <div class="d-flex">
                   <input type="file" id="product_image3" name="product_image3" class="form-control w-80 m-auto" required="required">
                   <img src="\website\admin_area/product_images/<?php echo $product_image3 ?>" alt="" class="product-img">
               </div>
        </div>
        <div class="form-outline w-50 m-auto mb-4">
