...
if(isset($_GET['edit_account'])){
  ...
  if(isset($_POST['user_update'])){
    ...
    // update query
   $update_data="update `user_table` set username='$username',user_email='$user_email',user_address='$user_address',user_mobile='$user_mobile',user_image='$user_image1' where user_id=$update_id";
...
<body>
   ...
   <form action="" method="post" enctype="multipart/form-data">
       ...
       <div class="form-outline mb-4 d-flex w-50 m-auto">
           ...
           <img src="\website\index\user_images\<?php echo $user_image ?>" alt="" class="edit_image">
       </div>
       <div class="form-outline mb-4">
